...
if __name__ == "__main__":
    ...
    weights_path = 'model_data/yolo_weight.h5'
    ...
    checkpoint = ModelCheckpoint(log_dir+"/ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5", save_weights_only=True, save_best_only=True)
