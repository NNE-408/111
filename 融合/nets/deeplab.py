...
from timm.models.mobilenetv3 import mobilenetv4_conv_small
...
def Deeplabv3(n_classes, inputs_size, alpha=1., backbone="mobilenet", downsample_factor=16):
    ...
    if backbone=="xception":
        ...
        #   获得两个特征层
        #----------------------------------#
        x, atrous_rates, skip1 = mobilenetv4_conv_small(img_input,alpha, downsample_factor=downsample_factor)
    else:
